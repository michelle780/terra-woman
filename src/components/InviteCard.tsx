...
export function InviteCard() {
  ...
  const text =
    "I've been using Terra Woman to track how I sleep, feel and cycle day to day. It's a calm little oasis — set up your own private log here:";

  async function share() {
    try {
      if (typeof navigator !== "undefined" && navigator.share) {
        await navigator.share({ title: "Terra Woman", text, url: link });
        return;
      }
  ...
  return (
    <div className="rise flex items-center gap-2.5 rounded-2xl bg-paper px-3 py-1.5 ring-1 ring-line">
      ...
      <div className="min-w-0 flex-1">
        <p className="text-xs font-semibold leading-tight">Invite a friend to Terra Woman</p>
